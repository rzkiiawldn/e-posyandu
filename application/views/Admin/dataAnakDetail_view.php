            ...
            <div class="card card-profile  text-black">
                ...
                <div class="card-body">
                    <?php foreach ($dataAnak as $value) : ?>
                        ...
                        <a href="<?= base_url() ?>Admin/dataanak_edit/<?= $nik; ?>" class="btn btn-primary btn-round">Update Data</a> -->
                    <?php endforeach; ?>
                </div>
            </div>
        </div>
                ...
                <div class="card card-profile text-black" style="width: 710px">
                    <div class="col-4">
                        <div class="list-group" id="list-tab" role="tablist">
                            <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Data KMS</a>
                        </div>
                    </div>
                    <div class="card-body" style="margin-top: -90px; height: 455px;">
                            <div id="graph"></div>
                    </div>
                </div>
            </div> -->
                                    ...
                                    foreach ($dataImunisasi as $value) : ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                echo $y . " tahun " . $m . " bulan ";
                                                ?></td>
                                            <td><?= date('d F Y', strtotime($value['tanggal_imunisasi']))  ?></td>
                                            ...
                                            <!-- <td class>
                                        <a class="badge badge-warning btn-lg" href="<?= base_url() ?>admin/dataImunisasi_edit/<?= $value['id_imunisasi']; ?>" role="button">Edit</a>
                                        <a class="badge badge-danger btn-lg" href="<?= base_url() ?>admin/hapusdataimunisasi/<?= $value['id_imunisasi']; ?>" role="button">Delete</a>
                                    </td> -->
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
